...
* contrib/update_f1/update_2012.php - [Updater for saison 2012]
*
*/
...
{
	$message = '<span style="color:green; font-weight: bold;font-size: 1.5em;">Update F1 WebTipp Saison 2012 </span><br />
				<br />
				English:<br />
				Script for automated update of Formular 1 Webtip saison 2012.<br />
				<br />
				...
				<br />
				German:<br />
				Script für automatisches Update der Formel 1 Saison 2012.<br />
				<br />
	...
	$message  = sprintf($message, '<a href="'.append_sid("update_2012.$phpEx?update=continue").'" class="gen">', '</a>', '<a href="'.append_sid( $phpbb_root_path . "index.$phpEx").'" class="gen">', '</a>');
